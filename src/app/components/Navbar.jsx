...
const CLOSE_BULGE  = "M1131,400 Q565.5,300 0,400 L0,861 L1131,861 Z";
...
export default function Navbar() {
  ...
  // fecha o menu com animação e navega ao terminar
  ...
  if (isOpen.current) {
    ...
    setOpen(false);
    closeMenu(() => navigateWithTransition(href));  // 👈 fecha o menu, depois a transição
  } else {
    ...
    <nav className="nav" ref={container}>
      <div className="nav-logo">
        <a href="/" onClick={(e) => handleNavigate(e, "/")}>
          <svg width="60" height="96" viewBox="0 0 255 96" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="menu">
        ...
        <div className="menu-col menu-col-links">
          ...
          <a href="/sobre" onClick={(e) => handleNavigate(e, "/sobre")}>Sobre</a>
          <a href="/projetos" onClick={(e) => handleNavigate(e, "/projetos")}>Projetos</a>
          <a href="/servicos" onClick={(e) => handleNavigate(e, "/servicos")}>Serviços</a>
          <a href="/contato" onClick={(e) => handleNavigate(e, "/contato")}>Contato</a>
        </div>
      </div>
    </nav>
  );
