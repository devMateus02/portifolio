...
export default function Navbar() {
  ...
  return (
    <nav className="nav" ref={container}>
      <div className="nav-logo flex flex-row items-center gap-3">
  ...
  <span className="nav-toggle-line" />
      ...
      <div className="menu">
        ...
        <div className="menu-col menu-col-links">
          ...
          <TransitionLink href="/sobre">Sobre</TransitionLink>
          <TransitionLink href="/projetos">Projetos</TransitionLink>
          <TransitionLink href="/servicos">Serviços</TransitionLink>
